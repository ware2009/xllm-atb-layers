...
#include "models/mistral/layer/decoder_layer.h"
...
MistralDecoderLayer::MistralDecoderLayer(const MistralLayerParam& param)
    : atb_speed::base::DecoderLayer<atb::infer::RmsNormParam>(param) {};

void MistralDecoderLayer::SetFusionAttentionLinearParam(
