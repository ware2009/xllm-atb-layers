 ...
 */
 ...
 #ifndef ATB_SPEED_MODELS_MISTRAL_PARALLEL_DECODER_LAYER_H
#define ATB_SPEED_MODELS_MISTRAL_PARALLEL_DECODER_LAYER_H
...
class MistralLayerParam : public atb_speed::base::LayerParam {
public:
    MistralLayerParam() {};
    ~MistralLayerParam() override {};
    int rank = 0;
    int worldSize = 1;
...
public:
    explicit MistralDecoderLayer(const MistralLayerParam& param);
    ~MistralDecoderLayer() override {};
