...
atb::Status CreateSelfAttentionOperation(const Code2WavTransformerLayerParam &param,
  ...
  attentionParam.maskType = atb::infer::SelfAttentionParam::MaskType::MASK_TYPE_SLIDING_WINDOW_NORM;
  //attentionParam.maskType = atb::infer::SelfAttentionParam::MaskType::MASK_TYPE_UNDEFINED;
  attentionParam.qkScale = 1.0 / sqrt(64);
  attentionParam.windowSize = 72;
