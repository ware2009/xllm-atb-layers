...
atb::Status AddMlpSplit(atb::GraphOpBuilder* &graphBuilder)
{
    ...
    splitParam.splitNum = 2;  // translated
...
{
    // translated,translatedlayerLinearQuantTypetranslated, translatedlayerLinearDescstranslated
    ...
    if (downQuantType == atb_speed::common::LinearQuantType::LINEAR_W8A8_DYNAMIC_QUANT && param.isPrefill) {
        ...
        aclnnParam.quantMode = "dynamic";  // dynamic, translatedx
    }
