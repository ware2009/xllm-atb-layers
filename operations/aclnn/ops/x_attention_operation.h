 ...
 */
 ...
 #ifndef ATB_SPEED_PLUGIN_ACLNN_X_ATTENTION_OPERATION_H
 #define ATB_SPEED_PLUGIN_ACLNN_X_ATTENTION_OPERATION_H
 ...
 namespace atb_speed::common {
     ...
     public:
         explicit XAttentionOperation(const std::string &name, AclNNXAttentionParam param);
         ~XAttentionOperation() override;
