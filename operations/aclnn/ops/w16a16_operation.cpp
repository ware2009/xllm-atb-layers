...
int W16A16Operation::CreateAclNNVariantPack(const atb::VariantPack &variantPack)
{
...
atb::Dims W16A16Operation::GetWeightStorageShape(const atb::TensorDesc atbTensorDesc) const
{
    ...
    if (atbTensorDesc.format == ACL_FORMAT_FRACTAL_NZ) {
        ...
        uint32_t blockSize = 16; // 16: translatedblockSizetranslated16translated
...
int W16A16Operation::CreateAclNNInTensorVariantPack(const atb::VariantPack &variantPack)
{
...
int W16A16Operation::CreateAclNNOutTensorVariantPack(const atb::VariantPack &variantPack)
{
    AclNNVariantPack &aclnnVariantPack = this->aclnnOpCache_->aclnnVariantPack;
