 ...
 */
#ifndef ATB_SPEED_PLUGIN_ACLNN_MOE_INIT_ROUTING_OPERATION_V3_H
#define ATB_SPEED_PLUGIN_ACLNN_MOE_INIT_ROUTING_OPERATION_V3_H
...
/// initRoutingNode.operation = new atb_speed::common::MoeInitRoutingV3Operation("MoeInitRoutingV3Operation",
///                                                                            initRoutingParam);
...
class MoeInitRoutingV3Operation : public AclNNOperation {
public:
    explicit MoeInitRoutingV3Operation(const std::string &name, MoeInitRoutingV3Param param);
    ~MoeInitRoutingV3Operation() override;
...
private:
    ...
    MoeInitRoutingV3Param param_;
};

}  // namespace common
}  // namespace atb_speed
#endif  // ATB_SPEED_PLUGIN_ACLNN_MOE_INIT_ROUTING_OPERATION_V3_H
